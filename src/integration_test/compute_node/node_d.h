...
#ifndef SEGAR_EXAMPLES_COMPONENT_TEST_NODE_D_H
#define SEGAR_EXAMPLES_COMPONENT_TEST_NODE_D_H
...
class NodeDComponent
 ...
 private:
  std::shared_ptr<Writer<IntegrationTestData>> node_d_writer_ = nullptr;
...
SEGAR_REGISTER_COMPONENT(NodeDComponent)

#endif  // SEGAR_EXAMPLES_COMPONENT_TEST_NODE_D_H
